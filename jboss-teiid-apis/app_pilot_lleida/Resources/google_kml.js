function google_kml(map, kml,mapRegion,finalPointLat,finalPointLon, initPointLat, initPointLon){
    ...
    (function() {
        ...
        goog.maps.kml.addRoutesToMap = function(map, kml,finalPointLat,finalPointLon, initPointLat, initPointLon) {
            try{
...
goog.maps.kml.addRoutesToMap(map,kml,finalPointLat,finalPointLon, initPointLat, initPointLon);
})();
