...
function timer(win1, goMapButton, mapRegion,medalContainer,mapRegion2,mapView, accuracyImage,finLon, finLat,initLat, initLon,aux,fitxadist2,backButtonMap,resumeView,resetButton,iniciLabel2,finalLabel2,timeLabel2,distanceLabel2,velocityLabel2, caloriesLabel2,finishButton, backButton, lliureBackButton){
