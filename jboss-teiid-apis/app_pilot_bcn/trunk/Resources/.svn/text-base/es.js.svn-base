	...
	var source = "Fuente de los datos: ";
	var loading = "Cargando";
	var unknown = "Temporalmente no disponible";
	var table_path = "/images/air_quality_es.png";
	var pollen_msg = "Los datos de polen y tiempo han sido actualizados por última vez hoy a las: ";
	var weather_msg = "Los datos de tiempo han sido actualizados por última vez hoy a las: ";
	var pollution_update_TS = "Los datos de la polución han sido actualizados por última vez hoy a las: ";
	var pollution_update_TS2 = "Información obtenida para el barrio: ";	
	
	var general_info_source = "Información obtenida para toda la ciudad.";
    ...
    var morning = "Mañana: ";
    var afternoon = "Tarde: ";
    var prediction = "Predicción";
    
    var no_connection_ = "No dispone de conexión a Internet";
